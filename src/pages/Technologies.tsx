        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 leading-tight">
              Technologies We
              <span className="bg-gradient-to-r from-sky to-primary bg-clip-text text-transparent"> Offer & Teach</span>
            </h1>
              ...
              <div key={category}>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {techs.map((tech, index) => (
                    ...
                    >
                      <div className="w-12 h-12 rounded-xl bg-gradient-primary flex items-center justify-center mb-4 shadow-soft group-hover:scale-110 transition-transform duration-300">
                        <span className="text-blue-900 font-bold text-lg">
                          {tech.name.charAt(0)}
                        </span>
                      </div>
                      <h3 className="font-bold text-blue-900 mb-2 group-hover:text-primary transition-colors">
                        {tech.name}
                      </h3>
