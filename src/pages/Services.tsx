            ...
            {services.map((service, index) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="w-14 h-14 rounded-2xl text-white  bg-blue-900 flex items-center justify-center flex-shrink-0 shadow-soft group-hover:scale-110 transition-transform duration-300">
                    <service.icon className="w-7 h-7 text-white-900" />
                  </div>
