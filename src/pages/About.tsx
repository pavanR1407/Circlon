        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 leading-tight">
              ...
              <span className="bg-gradient-to-r from-sky to-primary bg-clip-text text-transparent"> Technology</span>
            </h1>
            <p className="text-primary-foreground/70 sm:text-xl font-semibold leading-relaxed">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-blue-900 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="p-6 rounded-2xl bg-gradient-primary text-primary-foreground shadow-soft">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div
                key={value.title}
                className="group p-6 rounded-2xl bg-card border border-border hover:border-primary/30 hover:shadow-card transition-all duration-300 text-center"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-4 group-hover:bg-gradient-primary group-hover:shadow-soft transition-all duration-300">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-900  mb-8">
              Whether you're looking to learn, grow, or build, TechSphere is here to help you succeed.
            </p>
